...
describe( "the iai function", function(){
  ...
  it("should have the following methods", function(){
    test.methods( iai, 'load', 'api' );
  })

  describe( "#load", function(){
    it( "should require the given path relative to the iai lib path", function(){
      assert.deepEqual( iai.load( "util/loader" ), require( "../lib/util/loader" ) );
    })
  })
  ...
  describe( "given an absolute path", function(){
    it( "should return a loader function", function(){
      assert.deepEqual( iai(__filename)( './' ), iai('util/loader')(__filename)( './' ) );
    })
  })

  describe( "#api", function(){
    it( "should return an instance of iai.api", function(){
      var api = iai.api( __dirname );
      assert.instanceOf( api, iai.api );
    })
  })
})

describe( "iai.api instances", function(){
  beforeEach(function(){
