...
var BaseValidator = oop.builder(function(opts){
  ...
  var validator = instance.validate.bind(instance);
  validator.o = instance;
  return validator;
}, {
  message: "Introduza un valor.",
  code: "empty",
...
var Empty = oop.builder(function(opts){
  return BaseValidator.call()
}, {
  message: "Introduza un valor.",
  code: "empty",
  clean: function( value ){
