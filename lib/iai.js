 ...
 * something or another depending on the `subject`.
 *     @param subject: a relative path or a module object
 *     (relative path case) delegates on iai.load
 *     (module case) delegates on iai-loader
 */

function iai( subject ) {
  // given a relative pathname
  if ( 'string' == typeof subject && !is.AbsolutePath( subject ) ) {
